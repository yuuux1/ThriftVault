...
export default function RegisterPage() {
  ...
  async function handleSubmit(
    ...
    try {
      ...
      showNotice(data.success ? "success" : "error", data.message || "Terjadi kesalahan saat mendaftar.");
      ...
      showNotice("error", "Terjadi kesalahan saat mendaftar.");
    } finally {
      setLoading(false);
    }
  }
        ...
        >
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-[rgba(15,156,154,0.16)] px-4 py-3 text-[var(--thrift-ink)] focus:border-[var(--thrift-teal)] focus:outline-none focus:ring-1 focus:ring-[var(--thrift-teal)]"
              required
            />
          </div>
